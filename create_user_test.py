...
# Функция для негативной проверки (КЭ и ГЗ)
...
# Не все необходимые параметры были переданы
...
# Параметр firstName состоит из английских символов
...
# Тест 10. Негативная проверка. Параметр firstName не передан в запросе
# Тест 10. Ошибка
